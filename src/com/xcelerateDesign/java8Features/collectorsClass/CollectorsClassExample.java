...
public class CollectorsClassExample {
    ...
    public static void main(String[] args) {
        ...
        List<String> names =
            Arrays.asList("Jinal", "Vaishvi", "Manish", "Vaishvi", "Jinal", "Jinal");
        ...
        employeeList.add(new Employee(1001, "Jinal", "Modi", "India"));
        employeeList.add(new Employee(1002, "Vaishvi", "Modi", "Oman"));
        employeeList.add(new Employee(1003, "Manish", "Modi", "India"));
